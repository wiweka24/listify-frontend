    ...
    <div className='flex w-full justify-center'>
      <div className='w-full md:w-5/6 lg:w-1/2 px-10 py-10'>
        ...
        <div className='md:flex w-full mt-20'>
          <div className='w-full md:w-[46%] md:mr-[8%]'>
          ...
          <div className="w-full md:w-[46%]">
            <h3 className='text-3xl font-bold'>Execution Date</h3>
            <input
        ...
        <div className='md:flex md:mt-20 items-start justify-center'>
          <div className='w-full md:w-[46%] md:mr-[8%]'>
        ...
        <div className='mt-28 flex justify-center'>
          <button
              className="w-3/5 md:w-2/5 bg-blue-500 text-white py-2 px-6 rounded hover:bg-indigo-400 duration-500"
              type='submit'
              > Add
          </button>
        </div>
