            ...
            <article className="w-auto flex space-x-6 my-7 mx-8">
              ...
              <div className="w-[99.5%]">
                <div className='flex items-center'>
                  <h1 class="mr-3 group-hover:text-white font-semibold text-lg text-slate-900">{act.actName}</h1>
                  {/* <dt class="sr-only">Title</dt> */}
                  {/* <dd class="mr-3 group-hover:text-white font-semibold text-slate-900"> {activity.actName}</dd> */}
                  <label class="group-hover:text-blue-200 text-sm text-slate-500">{act.actCategory}</label>
                  {/* <dt class="sr-only">Title</dt> */}
